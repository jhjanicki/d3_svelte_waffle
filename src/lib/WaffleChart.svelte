<script>
    import WaffleViz from "./WaffleViz.svelte";
    import WaffleLabel from "./WaffleLabel.svelte";
    import WaffleLegend from "./WaffleLegend.svelte";
  ...
  <svg
    ...
    height={length + margin*2 + legendHeight}
  >
